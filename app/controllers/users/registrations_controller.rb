...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  # Added logic to apply session info to user
  ...
  def create
    ...
    # Currently I favor this explicit approach. Could be refactored by overriding new_with_session.
    if session[:fb_uid]
      resource.fb_uid = session[:fb_uid]
      resource.fb_token = session[:fb_token]
      resource.fb_token_expiration = session[:fb_token_expiration]
    end
    ...
    if resource.save
      ...
      if resource.active_for_authentication?
        ...
        UserMailer.new_user(resource).deliver_later
  ...
  # Added to clear Facebook session
